...
import { Quote, Award, BookOpen, GraduationCap, User } from 'lucide-react'
      ...
      <div className="flex flex-col lg:flex-row gap-8 mb-12">
        ...
        <div className="w-full lg:w-1/3 flex-shrink-0">
          <div className="relative overflow-hidden rounded-lg shadow-md bg-gradient-to-b from-purple-100 to-white p-4">
            ...
            <div className="absolute bottom-0 left-0 right-0 bg-gradient-to-t from-purple-600 to-purple-600/80 text-white p-4 text-center">
              <h3 className="text-lg font-medium">연구소장</h3>
        ...
        <div className="w-full lg:w-2/3">
          ...
          <div className="space-y-4 text-gray-700 leading-relaxed">
            <p>
              학생들을 지도한 경험을 통해 수많은 아이들을 만나고, 또 그들이
              성장해가는 과정을 함께해왔습니다. 그 과정에서 제가 얻어낸 깨달음
              한 가지는{' '}
              <span className="font-semibold text-purple-700">
                "학습의 본질은 성적이 아니라 방향과 습관"
              </span>
              이라는 점입니다.
            </p>
            ...
            <p>
              ...
              에 대한{' '}
              <span className="font-semibold text-purple-700">스스로의 답</span>
              을 찾는 데서 시작됩니다.
            </p>

            <p>
              저희 캠프는 이 답을 찾게 해주는 특별한 프로그램입니다. 전국 각지의
              의대생 멘토들이 직접 학생들과 함께 생활하며 최상위권의 공부습관을
              전수하고, 각자의 학습 여정을 진솔하게 들려주는 이 캠프는 그 자체로{' '}
              <span className="font-semibold text-purple-700">
                '살아있는 교육'
              </span>
              이라 할 수 있습니다.
            ...
            <p>
              진학을 꿈꾸는 학생들에게 가장 필요한 것은 단기적 성취가 아니라,
              지속 가능한 루틴과{' '}
              <span className="font-semibold text-purple-700">
                스스로를 이끄는 힘
              </span>
              입니다. 저희 캠프는 이 두 가지를 함께 갖춘 제가 자신 있게 추천할
              수 있는 진로·학습 통합 프로그램입니다. 학생은 물론 학부모님들께도
              진심으로 권합니다.
            </p>

            <p>
              이 캠프는 단순한 여름방학 프로그램이 아니라, 아이의 진짜 성장을
              위한 전환점이 될 것입니다. 교육 현장에서 수많은 아이들을 지켜봐 온
              저 김동헌이{' '}
              <span className="font-semibold text-purple-700">
                자신 있게 추천
              </span>
