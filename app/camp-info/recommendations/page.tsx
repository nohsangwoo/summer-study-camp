  ...
  const testimonials: Testimonial[] = [
    ...
    },
    {
      ...
      content: [
        ...
        "이러한 캠프는 올바른 학습 목표 설정과 공부 습관 형성에 도움을 주며, 학습에 대한 동기를 부여한다는 점에서 인기를 끌고 있습니다. '전교 1등 공부 습관 캠프', 전1공 캠프는 전원 의대생 멘토들과 함께하는 특별한 진로 비전 캠프로, 미래 의사와 명문대 진학을 꿈꾸는 학생들에게 맞춤형 동기를 부여하고자 기획되었습니다.",
