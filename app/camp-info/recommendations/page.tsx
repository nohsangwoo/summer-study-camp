  ...
  const testimonials: Testimonial[] = [
    {
      ...
      content: [
        "이사람은 꿈을 품고 있는 많은 학생들에게 있어, 그 여정의 첫걸음은 단순한 성적 그 이상에서 시작됩니다.",
        "공부를 잘하는 것과 '어떻게 공부해야 하는가'를 아는 것은 분명히 다릅니다. 전일공 캠프는 전국의 의대생들로 구성된 멘토단이 아이들에게 진짜 공부습관, 올바른 동기, 그리고 삶의 태도를 전해주는 토탈케어의 캠프입니다.",
        "이 캠프의 가장 큰 장점은 단순한 정보 전달이나 공부법 강의가 아닙니다. 실제 전교 1등 출신의 의대생들과 함께 생활하며 배우는 생생한 멘토링은, 책이나 인터넷으로는 절대 얻을 수 없는 경험입니다.",
        "의사가 되기까지의 구체적인 과정, 실패와 성공, 고민과 극복의 순간들이 고스란히 전달되는 시간 속에서 학생들은 단지 의대 진학을 넘어서 자신의 삶을 깊이 들여다보고 설계하는 계기를 만나게 될 것입니다.",
        "저 역시 한 사람의 의사로서, 그리고 교육을 진심으로 응원하는 의료인으로서 이런 뜻깊은 캠프를 함께 후원하게 되어 매우 기쁘게 생각합니다. 미래를 준비하는 아이들이 올바른 길 위에서 더 멀리, 더 높이 도약할 수 있도록 전일공 캠프가 소중한 출발점이 되기를 진심으로 응원합니다.",
        "의대를 꿈꾸든, 아직 꿈이 명확하지 않든 이 캠프는 모든 학생에게 '나답게 성장할 수 있는 방법'을 알려주는 소중한 기회가 될 것입니다.",
      ],
      education: [
        "부산대학교 의과대학 졸업",
        "부산대학교 재활의학과 전문의",
