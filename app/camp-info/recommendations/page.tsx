...
export default function RecommendationsPage() {
  const testimonials: Testimonial[] = [
    ...
    },
    {
      ...
      name: '정제원',
      title: 'EBS대표컨설턴트',
      image: '/recommendations/EBS-Representative-Consultant.png',
      content: [
      ...
      education: ['서울대학교 사범대학 졸업'],
      career: [
        'EBSi 입시(진학)대표 강사',
        '숭의여자고등학교 재직',
        '2006년 부터 입시 진로진학 지도 20년',
        '2008년 부터 서울시 교육청 진학지도지원단 활동',
        '2012년 부터 TBS-TV 상담받고 대학가자 진행',
      ],
    },
  ]
