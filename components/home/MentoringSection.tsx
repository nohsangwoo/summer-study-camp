        ...
        <div className="text-center mb-8 my-24">
          ...
          <div className="max-w-4xl mx-auto text-gray-700 mb-8 bg-white p-6 rounded-lg shadow-md">
            <p className="text-lg font-medium mb-4">
              전교1등 공부방법 연구소 전1공 캠프에 오신 것을 환영합니다.
            </p>
            <div className="space-y-4 text-left">
              <p>
                안녕하세요. 전교1등공부습관캠프 전1공의 대표이자 공부연구소장인 부산대 의대 김동헌입니다. 전국 의대생으로 구성된 저희 전1공 캠프는, 단순한 과외나 공부 지도가 아닌 <span className="font-semibold text-blue-600">'전교 1등의 공부법'</span>과 <span className="font-semibold text-blue-600">'자기주도 학습 시스템'</span>을 바탕으로 공부방해요소가 넘치는 요즘 아이들에게 실질적인 공부방법과 전략을 함께 제시하고자 합니다.
              </p>
              <p>
                아울러 영어·수학·국어 진도 유지부터 의대(명문대) 합격 전략 상담, 자기주도 생기부 설계, 명사 특강과 병원 견학까지 전1공 캠프는 학습과 진로, 동기부여를 모두 아우르는 고밀도의 프로그램을 운영합니다.
              </p>
              <p>
